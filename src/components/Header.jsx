...
function Header({ openMenu }) {
  return (
    <header className="relative h-90 tablet:h-100 desktop:h-auto px-6 tablet:px-16 py-12 desktop:p-16 bg-[url('/images/mobile-image-hero-1.jpg')] tablet:bg-[url('/images/desktop-image-hero-1.jpg')] bg-cover bg-center desktop:w-210 desktop:shrink-0">
      <nav>
