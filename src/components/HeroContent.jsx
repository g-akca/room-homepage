...
function HeroContent() {
  return (
    <section className="px-8 tablet:px-16 flex flex-col gap-8 tablet:gap-6">
      ...
      <button type="button" className="flex justify-between items-center tablet:justify-start tablet:gap-6">
